...
TEST(LifterKinematicsTest, LineArm_OriginFulcrum_IK) {
  {
    LifterKinematics kinematics({0_m, 0_m}, 0_m, {0_m, 0_m}, {0_m, 0_m}, {0_m, 0_m});
    frc::Translation2d pose{1_m, 0_m};
    auto joints = kinematics.GetJointsFromEffector(pose, false);
...
TEST(LifterKinematicsTest, OffsetLineArm_OriginFulcrum_IK) {
  {
    LifterKinematics kinematics({0_m, 0_m}, -0.1_m, {0_m, 0_m}, {0_m, 0_m}, {0_m, 0_m});
...
TEST(LifterKinematicsTest, OffsetLineArm_EffectorOffset_OriginFulcrum_IK) {
  {
    LifterKinematics kinematics({0_m, 0_m}, -0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
  ...
  }
  {
    LifterKinematics kinematics({0_m, 0_m}, -0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
    frc::Translation2d pose{1.1_m, -0.3_m};
    auto joints = kinematics.GetJointsFromEffector(pose, true);
    EXPECT_TRUE(UnitEqual(joints.shoulderAngle, 0_rad));
    EXPECT_TRUE(UnitEqual(joints.armLen, 1_m, 0.005_m));
  }
  {
...
TEST(LifterKinematicsTest, OffsetLineArm_EffectorOffset_TranslatedFulcrum_IK) {
  {
    LifterKinematics kinematics({1_m, 2_m}, -0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
  ...
  {
    LifterKinematics kinematics({-1_m, 3_m}, 0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
  ...
  {
    LifterKinematics kinematics({-1_m, -1_m}, -0.1_m, {0.1_m, -0.2_m}, {0_m, 0_m}, {0_m, 0_m});
  ...
  {
    LifterKinematics kinematics({6_m, 4_m}, -0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
  ...
  {
    LifterKinematics kinematics({3.5_m, 1.5_m}, 0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
  ...
  {
    LifterKinematics kinematics({5_m, 10_m}, -0.1_m, {0.1_m, -0.2_m}, {0_m, 0_m}, {0_m, 0_m});
  ...
  {
    LifterKinematics kinematics({30_m, -10_m}, -0.1_m, {0.1_m, -0.2_m}, {0_m, 0_m}, {0_m, 0_m});
  ...
  {
    LifterKinematics kinematics({3_m, 9_m}, -0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
  ...
  {
    LifterKinematics kinematics({0.1_m, 0.2_m}, 0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
...
TEST(LifterKinematicsTest, LineArm_OriginFulcrum_FK) {
  {
    ...
    auto pose = kinematics.GetEffectorPose(state, false);
...
TEST(LifterKinematicsTest, OffsetLineArm_EffectorOffset_TranslatedFulcrum_FK) {
  ...
  {
    LifterKinematics kinematics({3_m, 5_m}, -0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
    ArmState state{1_m, 0_deg};
    auto pose = kinematics.GetEffectorPose(state, false);
  ...
  {
    LifterKinematics kinematics({7_m, 3_m}, 0.1_m, {0.1_m, -0.2_m}, {0_m, 0_m}, {0_m, 0_m});
    ArmState state{1_m, 0_deg};
    auto pose = kinematics.GetEffectorPose(state, false);
  ...
  {
    LifterKinematics kinematics({0.5_m, 0.6_m}, 0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
    ArmState state{1_m, 45_deg};
    auto pose = kinematics.GetEffectorPose(state, false);
  ...
  {
    LifterKinematics kinematics({100_m, 200_m}, -0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
    ArmState state{1_m, 45_deg};
    auto pose = kinematics.GetEffectorPose(state, false);
  ...
  {
    LifterKinematics kinematics({15_m, 10_m}, 0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
    ArmState state{1_m, 90_deg};
    auto pose = kinematics.GetEffectorPose(state, false);
  ...
  {
    LifterKinematics kinematics({25_m, 20_m}, -0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
    ArmState state{1_m, 90_deg};
    auto pose = kinematics.GetEffectorPose(state, false);
  ...
  {
    LifterKinematics kinematics({9_m, 8_m}, -0.1_m, {0.1_m, 0.2_m}, {0_m, 0_m}, {0_m, 0_m});
    ArmState state{1_m, -45_deg};
    auto pose = kinematics.GetEffectorPose(state, false);
...
TEST(LifterKinematicsTest, ShoulderActuatorConversions) {
  LifterKinematics kinematics({-12_in, 50_in}, 0_m, {0_m, 0_m}, {-14.75_in, 4.5_in}, {14_in, -2.5_in});
  auto boomExtension = kinematics.ShoulderAngleToBoomExtension(0_deg);
  EXPECT_TRUE(UnitEqual(boomExtension, 46.15_in, 0.1_in));
  boomExtension = kinematics.ShoulderAngleToBoomExtension(-58.0078_deg);
  EXPECT_TRUE(UnitEqual(boomExtension, 33.29_in, 0.1_in));
}
