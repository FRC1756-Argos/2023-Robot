...
class DriveOverShargingStation : public frc2::CommandHelper<frc2::CommandBase, DriveOverShargingStation> {
 public:
  DriveOverShargingStation(SwerveDriveSubsystem* drive, units::degree_t approachAngle, units::degree_t robotYaw);
