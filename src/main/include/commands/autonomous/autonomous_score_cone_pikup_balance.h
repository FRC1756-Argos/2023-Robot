...
class AutonomousScoreConePickupBalance
    : public frc2::CommandHelper<frc2::CommandBase, AutonomousScoreConePickupBalance>
    , public AutonomousCommand {
 public:
  AutonomousScoreConePickupBalance(SwerveDriveSubsystem& drive,
