...
class AutonomousCableProtector3Gp
    : public frc2::CommandHelper<frc2::CommandBase, AutonomousCableProtector3Gp>
    , public AutonomousCommand {
 public:
  AutonomousCableProtector3Gp(SwerveDriveSubsystem& drive,
